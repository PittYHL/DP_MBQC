...
first_loc = 'u'
file_name = "results/qft15_" + first_loc + "_" + str(rows) + "_" + str(keep) + ".txt"
QAOA = 0
...
np.savetxt("example/qft6_111.csv", n_map, fmt = '%s',delimiter=",")
...
for i in range(12, 14, 2):
    file_name = "./results/hwea15_" + first_loc + "_" + str(rows) + "_" + str(i) + reduced
